...
def game_scene():
   ...
   def show_apple():
       #this function places the apple at a random location
       apple.move(random.randint(0 + 
               constants.SPRITE_SIZE,constants.SCREEN_X - 
               constants.SPRITE_SIZE),(random.randint(0 + 
               constants.SPRITE_SIZE,constants.SCREEN_Y - 
   ...
   while True:
       ...
       if stage.collide(snakes[constants.HEAD_INDEX].x , snakes[constants.HEAD_INDEX].y,
                        snakes[constants.HEAD_INDEX].x + 15, snakes[constants.HEAD_INDEX].y + 15, 
                        apple.x, apple.y,
       ...
       if snakes[constants.HEAD_INDEX].x > (constants.SCREEN_X - constants.SPRITE_SIZE):
            collision = True
       for coords in wormCoords:
           x= coords['x']
           if x < 0 :
                collision = True
       if snakes[constants.HEAD_INDEX].y <  0:
                collision = True
       if snakes[constants.HEAD_INDEX].y > (constants.SCREEN_Y - constants.SPRITE_SIZE):
                collision = True
       ...
       for snake_number in range (1,len(snakes)):
           if snakes[snake_number].x > 0:
                       if stage.collide(snakes[constants.HEAD_INDEX].x , 
                                        snakes[constants.HEAD_INDEX].y,
                                        snakes[constants.HEAD_INDEX].x + 15,
                                        snakes[constants.HEAD_INDEX].y + 15,
